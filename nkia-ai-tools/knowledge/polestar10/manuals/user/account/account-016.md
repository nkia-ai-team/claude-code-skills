---
menu_path: "사용자정의항목_SNMP"
feature: "SNMP OID"
admin_required: false
original_title: "사용자정의항목_SNMP"
category: account
...
<tbody>
<tr class="odd">
<td><p><img src="./images/account-016/media/image3.png" style="width:0.21667in;height:0.21667in" />노트</p>
<p>[운영 관리] &gt; [사용자 정의 템플릿] &gt; [SNMP OID] 메뉴에서 템플릿을 먼저 등록해야 SNMP OID 등록이 가능합니다. SNMP OID 목록에는 로그인 사용자에게 읽기 권한이 할당된 SNMP OID만 표시됩니다.</p></td>
</tr>
</tbody>
</table>

![](./images/account-016/media/image4.png)
...
![](./images/account-016/media/image5.png)
...
사용자 정의 SNMP OID 목록에서 각 SNMP OID의 이름을 클릭하면 SNMP OID 결과에 대한 성능 정보 드로어가 화면에 표시됩니다. 대표지표 차트에서는 수치 데이터에 대한 데이터를 차트 형태로 확인할 수 있으며 하단 테이블에서는 정의되어 있는 OID에 대해 마지막 수집 데이터를 확인할 수 있습니다. 문자열 형식의 데이터(![](./images/account-016/media/image6.png))는 이름을 클릭하면 SNMP OID 문자 데이터 이력 드로어가 화면에 표시되어 데이터 변경 이력을 확인할 수 있습니다.

![](./images/account-016/media/image7.png)

> ▶ \[그림4\] 사용자 정의 SNMP OID 성능 정보 드로어

![](./images/account-016/media/image8.png)
