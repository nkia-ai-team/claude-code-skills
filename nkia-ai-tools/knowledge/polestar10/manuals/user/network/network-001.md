...
![](./images/network-001/media/image10.png)
...
![](./images/network-001/media/image11.png)

▶ \[그림2\] 모델 사전 및 전용 OID 정의 상세

> 전용 OID 정의 추가

1.  목록 우측 상단의 \[추가\] 버튼 클릭

2.  모델 사전 정보와 전용 OID 정의 입력
...
![](./images/network-001/media/image12.png)
...
<tr class="header">
<th>1회 요청 최대 수</th>
<th>SNMP 요청 시 1회 최대 요청 수량을 설정합니다</th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
| 대기시간 (ms) | ICMP 응답 대기 시간을 설정합니다.  |
| --------- | ---------------------- |
| 재시도 횟수    | ICMP 요청 재시도 횟수를 설정합니다. |

인터페이스 설정

\[인터페이스 설정\] 탭을 선택하여 네트워크 인터페이스 모니터링에서 사용되는 정보를 설정할 수 있습니다.

![](./images/network-001/media/image13.png)
...
\[MIB 파일 관리\] 탭을 선택하여 POLESTAR에서 MIB 파일을 관리할 수 있습니다.

![](./images/network-001/media/image14.png)
...
<tbody>
<tr class="odd">
<td><p><img src="./images/network-001/media/image15.png" style="width:0.21667in;height:0.21667in" />노트</p>
...
![](./images/network-001/media/image16.png)
...
![](./images/network-001/media/image17.png)
